...
export const SvgContainer: React.FC<PropsSvgContainer> = ({
    ...
    return (
        <div className="flex items-center w-[58rem]">

        <div className="p-20 w-full">
            <div className="bg-white rounded-lg shadow-lg w-full">
                {!isLoadImage ? <div className="animate-pulse bg-gray-300 rounded-t-lg h-[38rem]  w-full"></div> : null}
                ...
                <div className="p-6">
                    ...
                    <div className="flex justify-end space-x-3">
                        <button title="Back to form" onClick={() => onBack(true)} className="inline-flex items-center justify-center  shadow rounded-lg active:scale-95 opacity-80  text-secondary-light bg-tertiary-light p-4 transition duration-300 ease-in-out hover:opacity-100 cursor-pointer ">
